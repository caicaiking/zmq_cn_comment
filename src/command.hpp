  ...
  struct command_t
{
    ...
    static std::string to_string(command_t::type_t t)
    {
        switch (t) {
            ...
            case activate_read: return "activate_read";
            case activate_write: return "activate_write";
            case hiccup: return "hiccup";
            case pipe_term: return "pipe_term";
            case pipe_term_ack: return "pipe_term_ack";
            case pipe_hwm: return "pipe_hwm";
            case term_req: return "term_req";
            case term: return "term";
            case term_ack: return "term_ack";
            case term_endpoint: return "term_endpoint";
            case reap: return "reap";
            case reaped: return "reaped";
            case inproc_connected: return "inproc_connected";
            case conn_failed: return "conn_failed";
            case pipe_peer_stats: return "pipe_peer_stats";
            case pipe_stats_publish: return "pipe_stats_publish";
